...
public class NuevoProductoDTO {
    ...
    /**
     * Constructor con todos los campos a excepcion de ID.
     ...
     */
    public NuevoProductoDTO(String nombre, Double precio, String descripcion, Tipo tipoProducto, List<IngredienteProductoDTO> ingredientes, byte[] imagenProducto) {
        this.nombre = nombre;
        this.precio = precio;
